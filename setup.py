...
dist = setup( name='opimd-utils',
    ...
    data_files=[('applications', ['data/opimd-messages.desktop', 'data/opimd-contacts.desktop', 'data/opimd-notes.desktop', 'data/opimd-dates.desktop']),
		...
		('locale/gl/LC_MESSAGES', ['data/po/gl/opimd-dates.mo','data/po/gl/opimd-contacts.mo','data/po/gl/opimd-notifier.mo','data/po/gl/opimd-notes.mo','data/gl/de/opimd-messages.mo']),
		('locale/es/LC_MESSAGES', ['data/po/es/opimd-dates.mo','data/po/es/opimd-contacts.mo','data/po/es/opimd-notifier.mo','data/po/es/opimd-notes.mo','data/es/de/opimd-messages.mo']),
